        ...
        <template #body>
          <div class="hot-news-list clearfix">
            <div class="left fl">
              ...
              <div class="sub-title">相机还可以这样玩! ?</div>
              <div class="description">9527个还有在这里浪</div>
            </div>
            <div class="right fr">
              <img :src="img1" alt="" />
            </div>
          ...
          <div class="hot-news-list clearfix">
            <div class="left fl">
              ...
              <div class="sub-title">来呀！快活呀~</div>
              <div class="description">9527个驴友也在这里~</div>
            </div>
            <div class="right fr">
              <img :src="img2" alt="" />
            </div>
          ...
          <div class="hot-news-list clearfix">
            <div class="left fl">
              ...
              <div class="sub-title">辣子鸡真香!</div>
              <div class="description">9527个美食博主分享了美食~~</div>
            </div>
            <div class="right fr">
              <img :src="img3" alt="" />
            </div>
